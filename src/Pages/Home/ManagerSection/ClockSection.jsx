...
const ClockSection = () => {
    ...
    return (
        <div className='w-5/6 md:w-full mx-auto'>
            ...
            <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-delay="300" data-aos-duration="2000" className='w-1/2 mx-auto bg-purple-100 p-6  border-purple-700 border-4 '>
