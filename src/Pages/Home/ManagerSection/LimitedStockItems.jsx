...
const LimitedStockItems = () => {
    ...
    return (
        <div className="w-5/6 md:w-full mx-auto text-center mb-16">
           ...
           <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-delay="200" data-aos-duration="2000" className="grid grid-cols-1 md:grid-cols-3 gap-6">
